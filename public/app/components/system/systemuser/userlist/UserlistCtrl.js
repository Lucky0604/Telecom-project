angular.module('UserlistCtrl', [])
    .controller('UserlistCtrl', function($http, $scope, $rootScope, $window) {
        ...
        $.ajax({
            type: 'get',
            url: "http://192.168.1.99:8989/dxjf/platform/user/querylist",
            async: false,
            contentType: "application/x-www-form-urlencoded; charset=gbk",
            data: {
                "param": datastr
        ...
        $scope.delStore = function(id, state) {
            ...
            $.ajax({
                    type: 'post',
                    async: false,
                    url: "http://192.168.1.99:8989/dxjf/platform/user/del" + "/" + id,
                    contentType: "application/x-www-form-urlencoded; charset=gbk",
                    dataType: 'json',
                    data: {
                        "id": id
