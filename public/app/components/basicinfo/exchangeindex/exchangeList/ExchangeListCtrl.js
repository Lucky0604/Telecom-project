angular.module('ExchangeListCtrl', [])
	.controller('ExchangeListCtrl', function($scope, $window) {
        ...
        $.ajax({
            type: 'get',
            url: "http://192.168.1.99:8989/dxjf/console/exchange/querylist",
            async: false,
        ...
        $scope.delStore = function(id, state) {
            ...
            $.ajax({
                    type: 'post',
                    async: false,
                    url: "http://192.168.1.99:8989/dxjf/console/exchange/del" + "/" + id,
                    contentType: "application/x-www-form-urlencoded; charset=gbk",
                    dataType: 'json',
                    data: {
                        "id": id
